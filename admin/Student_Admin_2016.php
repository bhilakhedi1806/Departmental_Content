...
if ($result)
{
	...
	echo "<tr><th>Enrollment_Number</th><th> Name</th><th>Edit</th><th>Delete</th></tr>";
		...
		echo "<td>" . $row->Name . "</td>";
                echo "<td><a href='Student_edit_2016.php?id=" . $row->Enrollment_Number. "'>Edit</a></td>";
		echo "<td><a href='Student_delete_2016.php?id=" . $row->Enrollment_Number . "'>Delete</a></td>";
...
?>
        ...
        <div>
            <table border="2px solid black">
                <tr>
                    <td>
                        <a href="Student_insert_2016.php"><strong>Add new Record</strong></a>
                    </td>
                </tr>
            </table>
        </div>
