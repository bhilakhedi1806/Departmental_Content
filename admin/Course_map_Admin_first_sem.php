...
if ($result)
{
	...
	echo "<tr><th>No</th><TH>Sub_code</th><th>Subjects</th><th>Edit</th><th>Delete</th></tr>";
		...
		echo "<td>" . $row->Subjects . "</td>";
                echo "<td><a href='Course_map_edit_first_sem.php?id=" . $row->Sub_code . "'>Edit</a></td>";
		echo "<td><a href='Course_map_delete_first_sem.php?id=" . $row->Sub_code . "'>Delete</a></td>";
...
?>
        ...
        <div>
            <table border="2px solid black">
                <tr>
                    <td>
            <a href="Course_map_insert_first_sem.php"><strong>Add new Record</strong></a>
                    </td>
                </tr>
            </table>
        </div>
