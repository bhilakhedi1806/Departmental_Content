...
<style> 
    ...
    <body>
        ...
        <h1 class="cse">&nbsp;&nbsp;&nbsp;&nbsp;list of student year of 2018</h1>
<?php
include('../connect.php');
...
if ($result)
{
	...
	echo "<tr><th>Enrollment_Number</th><th> Name</th><th>Edit</th><th>Delete</th></tr>";
		...
		echo "<td><a href='Student_delete_2018.php?id=" . $row->Enrollment_Number . "'>Delete</a></td>";
...
?>
        ...
        <div>
            <table border="2px solid black">
                <tr>
                    <td>
                        <a href="Student_insert_2018.php"><strong>Add new Record</strong></a>
                    </td>
                </tr>
            </table>
        </div>
